...
class ShieldGuardBot(game: MegamanMaverickGame) : AbstractEnemy(game, size = Size.SMALL), IFreezableEntity, IFaceable {

    companion object {
        const val TAG = "ShieldGuardBot"
        ...
        private val animDefs = orderedMapOf(
            ...
            "turn" pairTo AnimationDef(3, 2, 0.05f, false),
            "attack" pairTo AnimationDef(2, 1, 0.05f, true)
        )
    ...
    override fun onSpawn(spawnProps: Properties) {
        ...
        when {
            vertical -> {
                body.setSize(1f * ConstVals.PPM, 0.75f * ConstVals.PPM)
