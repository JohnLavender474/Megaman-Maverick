...
class CarriCarry(game: MegamanMaverickGame) : AbstractEnemy(game, size = Size.MEDIUM), IMotionEntity, IAnimatedEntity, IFaceable {
    ...
    override fun defineBodyComponent(): BodyComponent {
        ...
        val damageableFixture = Fixture(
            body, FixtureType.DAMAGEABLE, GameRectangle().setSize(
                1.75f * ConstVals.PPM, 0.5f * ConstVals.PPM
            )
        )
