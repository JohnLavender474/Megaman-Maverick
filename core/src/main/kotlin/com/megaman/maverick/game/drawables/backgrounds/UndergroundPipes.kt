...
class UndergroundPipes(game: MegamanMaverickGame, it: RectangleMapObject) : Background(
    game,
    key = TAG,
    startX = it.rectangle.x,
    startY = it.rectangle.y,
    model = game.assMan.getTextureRegion(TextureAsset.BACKGROUNDS_6.source, TAG),
