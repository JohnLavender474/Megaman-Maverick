...
enum class SoundAsset(src: String, val seconds: Float) : IAsset {
    ...
    ENEMY_BULLET_SOUND("enemy_shoot.mp3", 0.25f),
    ...
    ASTEROID_EXPLODE_SOUND("asteroid_explode.wav", 0.5f),
    ...
    SMB3_PIPE_SOUND("smb3_pipe.wav", 0.75f),
    SMB3_COIN_SOUND("smb3_coin.wav", 0.9f),
    SMB3_BEANSTALK_SOUND("smb3_beanstalk.wav", 1.10f);
