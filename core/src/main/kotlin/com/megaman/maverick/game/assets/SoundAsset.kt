...
enum class SoundAsset(src: String, val seconds: Float) : IAsset {
    ...
    DINK_SOUND("dink.ogg", 1f),
    ERROR_SOUND("error.ogg", 1f),
    THUMP_SOUND("thump.ogg", 1f),
    JUMP_SOUND("jump.ogg", 1f),
    CHILL_SHOOT_SOUND("chill_shoot.ogg", 1f),
    WHOOSH_SOUND("whoosh.ogg", 2f),
    PAUSE_SOUND("pause_menu.ogg", 1f),
    EXPLOSION_1_SOUND("explosion1.ogg", 2f),
    EXPLOSION_2_SOUND("explosion2.ogg", 0.5f),
    BEAM_OUT_SOUND("teleport_out.ogg", 1f),
    ENERGY_FILL_SOUND("energy_fill_mm9.ogg", 1f),
    SELECT_PING_SOUND("select_ping.ogg", 2f),
    ENEMY_BULLET_SOUND("enemy_shoot.ogg", 0.25f),
    ENEMY_DAMAGE_SOUND("enemy_damage.ogg", 1f),
    MEGAMAN_LAND_SOUND("megaman_land.ogg", 1f),
    MEGAMAN_DAMAGE_SOUND("megaman_damage.ogg", 1f),
    DEFEAT_SOUND("megaman_defeat.ogg", 2f),
    SWIM_SOUND("swim.ogg", 1f),
    BOSS_DOOR_SOUND("boss_door.ogg", 1f),
    CURSOR_MOVE_BLOOP_SOUND("cursor_move_bloop.ogg", 1f),
    SPLASH_SOUND("water_splash.ogg", 1f),
    BEAM_SOUND("beam_in.ogg", 1f),
    MEGA_BUSTER_CHARGING_SOUND("buster_charging_fadeout.ogg", 4f),
    AIR_SHOOTER_SOUND("air_shooter.ogg", 1f),
    ATOMIC_FIRE_SOUND("atomic_fire.ogg", 1f),
    CRASH_BOMBER_SOUND("crash_bomber.ogg", 1f),
    MEGA_BUSTER_BULLET_SHOT_SOUND("buster_bullet_shot.ogg", 1f),
    MEGA_BUSTER_CHARGED_SHOT_SOUND("buster_charged_shot_v2.ogg", 1f),
    ...
    MM2_MECHA_DRAGON_SOUND("mecha_dragon.ogg", 1f),
