...
import com.megaman.maverick.game.entities.enemies.Cokeyro
...
class MegamanMaverickGame(
    ...
    companion object {
        ...
        const val VERSION = "ALPHA 1.10.0"
        ...
        val TAGS_TO_LOG: ObjectSet<String> = objectSetOf(Cokeyro.TAG, Cokonut.TAG)
