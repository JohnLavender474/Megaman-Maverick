...
import com.megaman.maverick.game.entities.hazards.InfernoMeteorShower
...
class MegamanMaverickGame(
    ...
    companion object {
        ...
        const val VERSION = "ALPHA 1.14.0"
        ...
        val TAGS_TO_LOG: ObjectSet<String> = objectSetOf(InfernoMeteorShower.TAG)
    ...
    private fun postCreate() {
        ...
        // screens.put(ScreenEnum.ROBOT_MASTER_INTRO_SCREEN.name, RobotMasterIntroScreenV2(this))
