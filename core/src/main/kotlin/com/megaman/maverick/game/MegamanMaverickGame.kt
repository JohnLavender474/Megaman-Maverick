...
import com.megaman.maverick.game.entities.megaman.sprites.MEGAMAN_ANIM_KEY_SUPPLIER_TAG
...
class MegamanMaverickGame(
    ...
    companion object {
        ...
        val TAGS_TO_LOG: ObjectSet<String> = objectSetOf(MEGAMAN_ANIM_KEY_SUPPLIER_TAG)
