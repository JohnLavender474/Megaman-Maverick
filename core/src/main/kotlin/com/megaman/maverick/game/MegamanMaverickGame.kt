...
import com.megaman.maverick.game.entities.hazards.TubeBeamer
...
class MegamanMaverickGame(
    ...
    companion object {
        ...
        val DEV_TAGS_TO_LOG: ObjectSet<String> = objectSetOf(TubeBeamer.TAG)
