...
class BigAssMaverickRobotOrbExplosion(game: MegamanMaverickGame) : MegaGameEntity(game), IBodyEntity, ISpritesEntity,
    IAnimatedEntity, IDamager, IHazard, IDirectional {

    companion object {
        const val TAG = "BigAssMaverickRobotOrbExplosion"
    ...
    override fun init() {
        if (explosionRegion == null || dissipateRegion == null) {
            ...
            dissipateRegion = atlas.findRegion("$TAG/ElectricDissipate")
        }
