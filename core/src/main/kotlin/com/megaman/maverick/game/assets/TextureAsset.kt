...
enum class TextureAsset(src: String) : IAsset {
    ...
    LEVEL_SELECT_SCREEN_V3("LevelSelectScreenV3.txt"),
    LEVEL_PAUSE_SCREEN("LevelPauseScreen.txt"),
    LEVEL_PAUSE_SCREEN_V2("LevelPauseScreenV2.txt"),
    WEAPON_GET("WeaponGet.txt"),
    MEGAMAN_BUSTER("Megaman_v3.txt"),
    MEGAMAN_ICE_CUBE("Megaman_v3_ICE.txt"),
    MEGAMAN_MOON_SCYTHE("Megaman_v3_MOON.txt"),
    MEGAMAN_MAGMA_WAVE("Megaman_v3_FIRE.txt"),
    MEGAMAN_PRECIOUS_GUARD("Megaman_v3_PRECIOUS.txt"),
    MEGAMAN_AXE_THROW("Megaman_v3_AXE.txt"),
    MEGAMAN_NEEDLE_SPIN("Megaman_v3_NEEDLE.txt"),
    MEGAMAN_RATTY_CLAWS("Megaman_v3_RAT.txt"),
    MEGAMAN_REACTOR_SHOT("Megaman_v3_REACTOR.txt"),
    MEGAMAN_RUSH_JETPACK("Megaman_v3_RUSH_JET.txt"),
    ...
    WILY_FINAL_BOSS("WilyFinalBoss.txt"),
    ...
    SMB3_SPECIALS("SMB3_Specials.txt");
