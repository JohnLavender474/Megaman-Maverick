...
import com.megaman.maverick.game.entities.special.CapsuleTeleporter
...
class MegamanMaverickGame(val params: MegamanMaverickGameParams) : Game(), IEventListener, IPropertizable {
    ...
    companion object {
        ...
        val TAGS_TO_LOG: ObjectSet<String> = objectSetOf(CapsuleTeleporter.TAG, MegaContactListener.TAG)
