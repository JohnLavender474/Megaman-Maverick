...
data class Contact(var fixture1: IFixture, var fixture2: IFixture) {
    ...
    fun getFixturesIfOneMatches(fixtureType: Any, out: GamePair<IFixture, IFixture>) =
        when (fixtureType) {
    ...
    fun getFixturesInOrder(fixtureType1: Any, fixtureType2: Any, out: GamePair<IFixture, IFixture>) =
        if (fixture1.getType() == fixtureType1 && fixture2.getType() == fixtureType2)
            out.set(fixture1, fixture2)
        else if (fixture2.getType() == fixtureType1 && fixture1.getType() == fixtureType2)
